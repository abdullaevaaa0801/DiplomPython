...
Примечания:
"""
При тестировании UI может появлятся капча " Я не робот", что приведет к падению теста. Последующий перезапуск решает проблему. Как убрать ее, такого навыка не имею.

"""
requirements.txt наполнен актуальными зависимостями 

Проект в ноушн: https://www.notion.so/Final-Project-Kinopoisk-a828ca8462bd46d39a22b95dcd1134f7
